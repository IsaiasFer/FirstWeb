      ...
      <section id="WeWork" className="contact">
        <div className="container">
          ...
          <div className="social">
            ...
            >
              <img alt="Twitter de Isaias Fernandez" src={twitterLogo} />{" "}
            </a>
            <a
            ...
            >
              <img alt="Facebook de Isaias Fernandez" src={facebookLogo} />{" "}
            </a>
            <a
            ...
            >
              <img alt="GitHub de Isaias Fernandez" src={githubLogo} />{" "}
            </a>
            <a
            ...
            >
              <img
                alt="Instagram de Isaias Fernandez"
